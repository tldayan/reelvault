  ...
  return (
    <>
      <MovieDetailsContainer media={900}>
        ...
        {trailerKey && <iframe className="trailer" src={`https://www.youtube.com/embed/${trailerKey}`} title="YouTube player" frameBorder="0" allow="encrypted-media;" allowfullscreen></iframe>}
