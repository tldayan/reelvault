...
export default function MovieDetails({ movieId }) {
  ...
  return (
    ...
    <div className='movie_details_container'>
      <img className='movie_details_poster' src={`https://image.tmdb.org/t/p/w154${movieData.poster_path}`} alt="" />
      <div className='movie_info_container'>
        ...
        <div className='movie_stats_container'>
          <div className='first_stats_container'>
            ...
            <p>Language: {movieData.original_language && movieData.original_language.toUpperCase()}</p>
          </div>
