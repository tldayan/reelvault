  ...
  useEffect(() => {
    ...
    const fetchActionMovies = async() => {
      ...
      try {
        ...
        const response1 = await fetch("https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=1&with_genres=28",{
        headers : {
        ...
        const response2 = await fetch("https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=2&with_genres=28",{
        headers : {
          accept: 'application/json',
          Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI1OGM1ZTU5YjRmMGUxMDQ1ODRjMzRlMjRmODZlOWJjMCIsInN1YiI6IjY0NTYzNzFlYzNjODkxMDEwNDE4ZWNkNyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.ZhRGCPIxeuJxggm9kJSFa7zmeFMV3byY4l9KprRAMxo'
        }})
  ...
  return (
    <div className='movietype_container'>
        ...
        <div className='movielist_container'>
          {!actionMovies.length ? <div className="load_animation"></div> : actionMovies.map(eachMovie => {
